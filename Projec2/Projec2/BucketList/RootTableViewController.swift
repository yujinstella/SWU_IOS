...
class RootTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "Bucket")
        do {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let bbucket = bucket[indexPath.row]
        var display : String = ""
        if let nameLabel = bbucket.value(forKey: "name") as? String {
        display = nameLabel }
        if let whatLabel = bbucket.value(forKey: "what") as? String {
        display = display + " - " + whatLabel
        }
        cell.textLabel?.text = display
        cell.detailTextLabel?.text = bbucket.value(forKey: "location") as? String
